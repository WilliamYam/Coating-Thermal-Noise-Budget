...
[magS00, phS00]=bode(sysmodel,2*pi*fcsParams.freq);%bode freq vector in radians/sec
...
setlinio('ctnFCS',io);
sysmodel = linearize('ctnFCS',io);
[magS02, phS02]=bode(sysmodel,2*pi*fcsParams.freq);%bode freq vector in radians/sec
...
setlinio('ctnFCS',io);
sysmodel = linearize('ctnFCS',io);
[magS20, phS20]=bode(sysmodel,2*pi*fcsParams.freq);%bode freq vector in radians/sec
...
setlinio('ctnFCS',io);
sysmodel = linearize('ctnFCS',io);
[magOL00, phOL00]=bode(sysmodel,2*pi*fcsParams.freq);
...
%linearize model
io=linio('ctnFCS/02 FCL/Sum',1,'looptransfer');
setlinio('ctnFCS',io);
sysmodel = linearize('ctnFCS',io);
[magOL02, phOL02]=bode(sysmodel,2*pi*fcsParams.freq);
...
setlinio('ctnFCS',io);
sysmodel = linearize('ctnFCS',io);
[magOL20, phOL20]=bode(sysmodel,2*pi*fcsParams.freq);
